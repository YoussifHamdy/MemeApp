package com.example.joe.memeapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topText = (TextView) findViewById(R.id.topMemeTextView);
        bottomText = (TextView) findViewById(R.id.bottomMemeTextView);
    ...
    public void hideKeyboard(View view){                               // To Hide the keyboard after clicking on try
